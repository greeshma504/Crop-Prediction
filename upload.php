...
if(isset($_POST['done'])){
 ...
 $season = $_POST['season'];
 $q = " INSERT INTO `crops`(`cropname`, `ph`, `soiltype`, `waterlevel`, `season`) 
 VALUES ('$cropname','$ph','$soiltype','$waterlevel','$season')";

 $query = mysqli_query($con,$q);
 echo "All Details Uploaded";
}
?>
...
<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
	    ...
	    <ul class="nav navbar-nav navbar-right">
	      <li><a href="admin.php"><span class="glyphicon glyphicon-log-in"></span> Logout/లాగ్అవుట్/लॉग आउट</a></li>
	    </ul>
	  </div>
	</nav>
...
<div class="container">
    	...
    	<form method="post">
    		...
    		<div class="form-group">
    			...
    			<input type="text" name="cropname" id="user" class="form-control" required="CROPNAME">
    		</div>

    		<div class="form-group">
    			<label for="user">pH : </label>
    			<input type="text" name="ph" id="user" class="form-control" required="pH">
    		</div>

    		<div class="form-group">
    			<label for="user">SOIL TYPE  : </label>
    			<input type="text" name="soiltype" id="user" class="form-control" required>
    		</div>

    		<div class="form-group">
    			<label for="user">WATER LEVEL : </label>
    			<input type="text" name="waterlevel" id="user" class="form-control" required="">
    		</div>

    		<div class="form-group">
    			<label for="user">SEASON : </label>
    			<input type="text" name="season" id="user" class="form-control" required="">
    		</div>
